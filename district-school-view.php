							...
							<div class="row">
								<div class="col-md-12">
									<div class="about-info">
										<h4>About <?php echo $run['school_name']?></h4>
                                        <div class="card">
						 <div class="card-body">
							 <div class="row">
							  <div class="col-md-12">
								...
								<canvas id="acscore"></canvas>
									...
									<div class="card flex-fill">
										<div class="card-header">
											<h5 class="card-title"><?php echo $run['school_name'];?> Classwise Top Performers list</h5>
										</div>
										<div class="card-body">
											<ul class="activity-feed">
												<?php
													while($run2 = mysqli_fetch_assoc($sql2))
													{
														...
														$cname=$run2['cname'];
														$sec=$run2['section']; 
														$sql3=mysqli_query($con,"SELECT s.student_name as student_name, max(e.total) as total from exam_totals e,exam m,student s where  s.student_id=e.student_id and e.school_id='$school_id' and e.eid=m.eid and m.status=1 and e.class_id='$cid' 
